            ...
            for dsp_sausaging in dsp_sausaging_sweep:
                if rffe_switching == 'off' and dsp_sausaging == 'on':
                    ...
                    for att_value_set in att_combinations:
                        ...
                        print(str.rjust('Run #' + str(nexp), 12) + ': RFFE switching ' + exp.metadata['rffe_switching'] + '; RFFE attenuators: ' + exp.metadata['rffe_attenuators'] + '; DSP sausaging ' + exp.metadata['dsp_sausaging'] + ' ')
                        nexp = nexp+1
